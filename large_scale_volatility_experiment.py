...
def run_single_agent(
    ...
    for step in range(num_steps):
        ...
        # Collect rewards after environment change
        if env_change_points and step > env_change_points[-1]:
...
def run_large_scale_experiment(
    ...
    for vol_interval in volatility_intervals:
        ...
        for beta_val in BETA_VALUES:
            ...
            comp = compute_statistical_comparison(adaptive_cond, fixed_cond)
